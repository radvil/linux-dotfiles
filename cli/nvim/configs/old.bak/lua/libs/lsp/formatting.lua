...
function M.toggle()
  ...
  if M.opts.autoformat then
    utils.info("Format on save enabled", { title = "LSP formatter" })
  else
    utils.warn("Format on save disabled", { title = "LSP formatter" })
  end
end
...
function M.format(opts)
  ...
  local format_opts = require("common.utils").opts("nvim-lspconfig").format
